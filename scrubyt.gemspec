Gem::Specification.new do |s|
  ...
  s.date = %q{2009-01-31}
  s.description = %q{scRUBYt! is an easy to learn and use, yet powerful and effective web scraping framework. 
                    It's most interesting part is a Web-scraping DSL built on HPricot and WWW::Mechanize, 
                    which allows to navigate to the page of interest, then extract and query data records 
                    with a few lines of code. It is hard to describe scRUBYt! in a few sentences - you have to see it for yourself!}
  s.email = ["peter@rubyrailways.com",'glenn.gillen@gmail.com']
  s.files = ['COPYING', 'README.rdoc', 'CHANGELOG', 'Rakefile', 
            ...
            "lib/scrubyt/logging.rb", "lib/scrubyt/output/post_processor.rb", 
            "lib/scrubyt/output/result.rb", "lib/scrubyt/output/result_dumper.rb", 
            "lib/scrubyt/output/result_node.rb", "lib/scrubyt/output/scrubyt_result.rb", 
            "lib/scrubyt/utils/compound_example_lookup.rb", 
            "lib/scrubyt/utils/ruby_extensions.rb", "lib/scrubyt/utils/shared_utils.rb", 
            "lib/scrubyt/utils/simple_example_lookup.rb", "lib/scrubyt/utils/xpathutils.rb", 
            "lib/scrubyt.rb"]
  s.test_files = ["test/blackbox_test.rb", "test/blackbox_tests/basic/multi_root.rb", 
            "test/blackbox_tests/basic/simple.rb", "test/blackbox_tests/detail_page/one_detail_page.rb", 
            "test/blackbox_tests/detail_page/two_detail_pages.rb", "test/blackbox_tests/next_page/next_page_link.rb", 
